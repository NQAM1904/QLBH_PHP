            ...
            <section>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php $stt = 1;foreach ($_SESSION['cart'] as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger" href="" ></i> Xóa</a>
                                        </td>
                                    </tr>
                                    <?php $sum += $value['price']*$value['count']; $_SESSION['total'] = $sum;  ?>
                            <?php $stt++; endforeach ?>
                        </Tbody>
                    </table>
                <div class="col-md-5 pull-right">
                    ...
                    <li class="list-group-item">
                        ...
                        <a href="<?=base_url()?>index.php?controller=website&action=payment" class="btn btn-success">Thanh toán</a>
                    </li>
                </ul>
            </div>
        </section>
