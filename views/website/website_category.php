    ...
    <div class="container">
        ...
        <div class="pull-right">
            <div class="beta-breadcrumb font-large">
                <a href="<?= base_url() ?>index.php?controller=website">Trang chủ</a> / <span>Danh mục</span>
            </div>
        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.php"><img src="<?= base_url() ?>assets/dest/images/products/1.jpg" alt=""></a>
                                    </div>
